...
> TagsGroupedResponse GetTagsGroupedByIdUsingGET1(ctx, appIds, tag, optional)
...
| **optional** | ***TagApiControllerApiGetTagsGroupedByIdUsingGET1Opts** | optional parameters                                                         | nil if no parameters |

### Optional Parameters

Optional parameters are passed through a pointer to a TagApiControllerApiGetTagsGroupedByIdUsingGET1Opts struct
| Name | Type | Description | Notes |
| ---- | ---- | ----------- | ----- |
...
> map[string]Dimension GetUsingGET(ctx, appIds, tag, optional)
...
| **appIds**   | **string**                              | appIds                                                                      |
| **tag**      | [**[]string**](string.md)               | tag                                                                         |
| **optional** | ***TagApiControllerApiGetUsingGETOpts** | optional parameters                                                         | nil if no parameters |

### Optional Parameters

Optional parameters are passed through a pointer to a TagApiControllerApiGetUsingGETOpts struct
| Name | Type | Description | Notes |
| ---- | ---- | ----------- | ----- |
...
> map[string]Dimension GetUsingGET1(ctx, appIds, tag, optional)
Gets values for specified tags for the given application identifiers appearing in the given time frame.
...
| **appIds**   | **string**                               | appIds                                                                      |
| **tag**      | [**[]string**](string.md)                | tag                                                                         |
| **optional** | ***TagApiControllerApiGetUsingGET1Opts** | optional parameters                                                         | nil if no parameters |

### Optional Parameters

Optional parameters are passed through a pointer to a TagApiControllerApiGetUsingGET1Opts struct
| Name | Type | Description | Notes |
| ---- | ---- | ----------- | ----- |
