...
// AwsSettingsControllerAPIService TODO Godoc Comment
...
*/
func (a *AwsSettingsControllerAPIService) UpdateUsingPUT(ctx context.Context, appID int64, dto CloudWatchSettings) (GenericAPIResponse, *http.Response, error) {
	var (
