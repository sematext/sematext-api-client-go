...
*/
func (a *TokensApiControllerApiService) DeleteAppToken1(ctx context.Context, appId int64, tokenId int64) (GenericMapBasedApiResponse, *http.Response, error) {
	var (
