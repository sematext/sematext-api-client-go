...
// BillingAPIService TODO Godoc comment
type BillingAPIService service

/*
GetDetailedInvoiceUsingGET Get invoice details
...
*/
func (a *BillingAPIService) GetDetailedInvoiceUsingGET(ctx context.Context, service string, year int32, month int32) (GenericAPIResponse, *http.Response, error) {
	var (
...
// ListAvailablePlansUsingGETOpts TODO Godoc commenting
type ListAvailablePlansUsingGETOpts struct {
	IntegrationID optional.Int64
	AppType       optional.String
}

/*
ListAvailablePlansUsingGET get available plans
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param optional nil or *ListAvailablePlansUsingGETOpts - Optional Parameters:
     * @param "IntegrationId" (optional.Int64) -  integrationId
     * @param "AppType" (optional.String) -  appType

@return GenericAPIResponse
*/
func (a *BillingAPIService) ListAvailablePlansUsingGET(ctx context.Context, localVarOptionals *ListAvailablePlansUsingGETOpts) (GenericAPIResponse, *http.Response, error) {
	var (
		localVarHTTPMethod  = strings.ToUpper("Get")
		localVarPostBody    interface{}
		localVarFileName    string
...
@return GenericAPIResponse
*/
func (a *BillingAPIService) UpdatePlanUsingPUT(ctx context.Context, appID int64, dto BillingInfo) (GenericAPIResponse, *http.Response, error) {
	var (
